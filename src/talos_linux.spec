...
"""PyInstaller spec for Linux frozen binary (clai-talos)."""
...
# Bundle runtime source files (excluding build outputs) so start.sh works in frozen mode.
...
datas.extend(
    [
        (str(project_root.parent / "start.sh"), "."),
